...
export function KontakteViewDialog({ open, onClose, record, onEdit }: KontakteViewDialogProps) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2 border-t border-border">
            <AttachmentsSection appId={APP_IDS.KONTAKTE} recordId={record.record_id} readOnly />
          </div>
        </div>
      </DialogContent>
    </Dialog>
